...
import ru.vladamamutova.services.warranty.model.ErrorResponse
import ru.vladamamutova.services.warranty.model.ErrorValidationResponse
...
class ErrorController {
    ...
    fun handleWarrantyNotFoundException(exception: WarrantyNotFoundException) : ErrorResponse {
        logger.error("Warranty Not Found Exception: " + exception.message)
